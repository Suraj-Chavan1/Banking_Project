...
const VisChat = () => {
  ...
  return (
    <div className='bg-gray-200 flex flex-col p-3'>
        <div className='text-black font-semibold text-3xl px-5'>Visualize Data with AI </div>
        <hr className='border-t mt-4' />
    <div className='bg-gray-200 min-h-screen p-3 flex flex-col min-h-screen justify-end'>
        ...
        <div className='flex justify-center'>
            <input type='text' className='p-4 w-full' placeholder='Visulaise data with natural language'></input>
            <button className='p-4 bg-black text-white hover:font-bold'>Send</button>
        </div>
    </div>
    </div>
  )
